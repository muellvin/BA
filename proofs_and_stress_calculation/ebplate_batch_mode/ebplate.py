...
def ebplate(b, h, t, sigma_a, sigma_b, stiffeners_ebp):
    ...
    string = ebp_path + r' /BATCH .\proofs_and_stress_calculation\ebplate_batch_mode\plate.EBP'
    os.system(r'"C:\Program Files (x86)\EBPlate\EBPlate.exe" /BATCH .\proofs_and_stress_calculation\ebplate_batch_mode\plate.EBP')
