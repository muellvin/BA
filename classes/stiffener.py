...
from shapely.geometry import LineString, Point
    ...
    def check_geometry(crosssection, stiffeners, stiffeners_proposition):
        ...
        if max_dis < mindis:
            ...
            elif (-math.pi/2) < angle < math.pi/2 and cut == False:
                corr_height -= disdiff / math.tan(angle) /2
                corr_b_inf -= disdiff / math.tan(angle) / 2
                corr_b_sup -= disdiff / math.tan(angle) / 2
