def get_sigma_sup(cs, line):
    ...
    if line.a.z <= line.b.z:
        z_sup = line.a.z - cs.get_center_z_tot()
    else:
        z_sup = line.b.z - cs.get_center_z_tot()
...
def get_sigma_inf(cs, line):
    ...
    i_y = cs.get_i_y()
    if line.a.z >= line.b.z:
        z_inf = line.a.z - cs.get_center_z_tot()
    else:
        z_inf = line.b.z - cs.get_center_z_tot()
...
def get_sigma_sup_red(cs, line):
    ...
    if line.p1.z <= line.p2.z:
        z_sup = line.p1.z - cs.get_center_z_tot()
    else:
        z_sup = line.p2.z - cs.get_center_z_tot()
...
def get_sigma_inf_red(cs, line):
    ...
    i_y = cs.get_i_y()
    if line.p1.z >= line.p2.z:
        z_inf = line.p1.z - cs.get_center_z_tot()
    else:
        z_inf = line.p2.z - cs.get_center_z_tot()
